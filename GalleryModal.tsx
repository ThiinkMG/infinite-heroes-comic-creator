...
export const GalleryModal: React.FC<GalleryModalProps> = ({ faces, title, onClose }) => {
            ...
            <div className="flex-1 w-full overflow-y-auto p-8" onClick={e => e.stopPropagation()}>
                {expandedFaceId !== null && expandedIndex >= 0 ? (
                    ...
                    <div className="relative w-full h-full flex flex-col items-center justify-center">
                        ...
                        <div className="mt-8 flex gap-4 w-full max-w-lg justify-center relative z-10">
                            <button
                            ...
                            <button
                                ...
                                className="comic-btn bg-green-500 text-white px-8 py-3 border-[3px] border-black font-bold hover:bg-green-400 uppercase tracking-widest"
                            >
                                ↓ Download
                            </button>
                            <button
                        ...
                        {validFaces.map((face) => (
                            <div key={face.id} className="relative group flex flex-col items-center">
                                ...
                                <button 
                                    ...
                                    className="mt-4 w-full bg-blue-600 text-white py-2 font-comic text-xs uppercase font-bold tracking-wider hover:bg-blue-500 border-2 border-black shadow-[2px_2px_0_rgba(0,0,0,1)] hover:-translate-y-0.5 transition-transform"
                                >
                                    ↓ Save Image
                                </button>
                            </div>
